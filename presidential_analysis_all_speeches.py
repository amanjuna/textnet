...
def main():
    ...
    for graph_generator in generators:
        for analysis in analyses:
            ...
            accuracy, precision, recall = run_analyses(graph_generator, analysis, emb, word2id_dict, id2word_dict)
            df[graph_generator][analysis] = precision
            #df.to_csv("results.csv")
            df.to_csv("results_precision.csv")
